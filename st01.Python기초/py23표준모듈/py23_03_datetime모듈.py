...
print(now)  # 2020-03-08 16:23:32.966027
print("년", now.year)
print("월", now.month)
print("일", now.day)
print("시", now.hour)
...
hour = now.hour
if hour > 12:
    print("오후", "%2d시%2d분%2d초" % (now.hour-12, now.minute, now.second))
else:
    print("오전", str)
...
def dateFormat(tm):
    str = "%04d-%02d-%02d %02d시%02d분%02d초" % (tm.year, tm.month, tm.day, tm.hour, tm.minute, tm.second)
    return str
...
print("datetime.time()로 시간 더하기>>> 현재에 1주 1일 1시간 1분 1초 더해서 출력하시오")
...
print("datetime.time()로 시간 더하기 빼기>>> 현재에 100일 전 날짜를 출력하시오")
print("현재", dateFormat(now))
...
########################
# 특정 시간 요소 교체하기 : replace() 메서드 로 시간더하기 >> 1년 1주 더하기
# 예시) 현재 2020-03-02 16:44:19
#       수정 2021-03-09 16:44:19
print("datetime.time()로 시간 더하기 >>> 현재에 1년 1주 더하여 를 출력하시오")
after=now.replace(
    year=now.year+1,
    day=now.day+7
)
